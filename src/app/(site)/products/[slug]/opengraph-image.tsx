...
// Image metadata
export const alt = "AnasTech Solutions Product";
...
export default async function Image({
  ...
  // Fallback if the slug is unknown — still render a branded card so the
  // share preview is never empty.
  const title = product?.title ?? "AnasTech Solutions";
  const tagline =
    product?.tagline ??
    "Enterprise software products built for real businesses.";
  const accent = product?.color ?? "#0F75BC";
