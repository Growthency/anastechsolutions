  ...
  useEffect(() => {
    ...
    fetch(`/api/admin/posts?id=${postId}`)
      ...
      .then((found) => {
        ...
        setCategory(found.category || 'Insights')
        ...
        // show_on_blog may be undefined for older rows — treat as true by default.
        setShowOnBlog(found.show_on_blog !== false)
        setLoading(false)
      })
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-32">
        <Loader2 className="w-8 h-8 animate-spin" style={{ color: '#0F75BC' }} />
      </div>
    )
  }
      ...
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            disabled={saving}
            className="flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold border border-red-500/30 text-red-500 hover:bg-red-500/10 transition-colors disabled:opacity-50"
          >
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl border p-4" style={{ background: cardBg, borderColor: cardBorder }}>
            ...
            {(metaTitle || title) && (
              <div className="mt-4 p-3 rounded-lg" style={{ background: dark ? 'rgba(255,255,255,0.03)' : '#f8fafc', border: `1px solid ${cardBorder}` }}>
                ...
                <p className="text-emerald-600 text-xs truncate">anastechsolutions.com{slug}</p>
          ...
          <div className="rounded-xl border p-4" style={{ background: cardBg, borderColor: cardBorder }}>
            ...
            <input
              ...
              style={inputStyle}
            />
            <datalist id="page-categories-edit">
