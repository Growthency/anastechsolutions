...
import {
  ...
  Upload, Undo2, Redo2, Pilcrow, Table,
...
export default function RichEditor({ value, onChange, resetKey }: RichEditorProps) {
  ...
  const selectImage = useCallback((img: HTMLImageElement) => {
    ...
    img.style.outline = '3px solid #0F75BC'
  ...
  const ToolBtn = ({ onClick, title, children, active }: {
    ...
    <button
      ...
      title={title}
      className={`p-1.5 rounded transition-colors ${btnHover} ${active ? 'bg-[#0F75BC]/20 text-[#0F75BC] ring-1 ring-[#0F75BC]/30' : btnDefault}`}
    >
      {children}
    </button>
  )
  ...
  return (
    <div className="rounded-xl border max-h-[75vh] overflow-y-auto relative" style={{ background: containerBg, borderColor: toolbarBorder }}>
      <div className="flex flex-wrap items-center gap-0.5 px-3 py-2 border-b sticky top-0 z-20" style={{ borderColor: toolbarBorder, background: toolbarBg }}>
        ...
        >
          {uploading
            ? <div className="w-4 h-4 border-2 border-[#0F75BC] border-t-transparent rounded-full animate-spin" />
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-xs font-semibold transition-colors ${
            viewMode === 'html'
              ? 'bg-[#0F75BC]/20 text-[#0F75BC] ring-1 ring-[#0F75BC]/30'
              : `${btnHover} ${btnDefault}`
          }`}
        >
          {viewMode === 'visual'
        ...
        className={`min-h-[500px] px-6 py-5 text-sm leading-relaxed outline-none max-w-none
          ...
          ${dark
            ? `[&_h1]:text-white [&_h2]:text-white [&_h3]:text-white [&_h4]:text-white [&_p]:text-slate-300
               ...
               [&_blockquote]:text-slate-400 [&_pre]:bg-slate-800 [&_pre]:text-[#0F75BC]
               [&_code]:bg-slate-800 [&_code]:text-[#0F75BC] [&_hr]:border-slate-700
            ...
            : `[&_h1]:!text-black [&_h2]:!text-black [&_h3]:!text-black [&_h4]:!text-black
               ...
               [&_blockquote]:!text-gray-700 [&_pre]:bg-slate-100 [&_pre]:!text-[#0F75BC]
               [&_code]:bg-slate-100 [&_code]:!text-[#0F75BC] [&_hr]:border-slate-300
          ...
          [&_li]:mb-1
          [&_a]:text-[#0F75BC] [&_a]:underline
          [&_blockquote]:border-l-4 [&_blockquote]:border-[#0F75BC] [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:my-4
        ...
        >
          ...
          >
            <div className="flex items-center gap-1.5 flex-1 min-w-0">
              <span className="text-[10px] font-bold text-[#0F75BC] shrink-0 uppercase">Alt</span>
              <input
                type="text"
                value={imgAlt}
                onChange={e => updateImgAlt(e.target.value)}
                placeholder="Enter alt text for SEO…"
                className="flex-1 min-w-0 px-2 py-1 rounded text-xs outline-none focus:border-[#0F75BC]"
                style={{
      ...
      {selectedLink && linkToolbarPos && (
        ...
        >
          ...
          >
            <Link className="w-3.5 h-3.5 shrink-0 text-[#0F75BC]" />
            ...
            <button
              ...
              style={{ color: dark ? '#94a3b8' : '#64748b' }}
              title="Edit link URL"
              onMouseEnter={e => { (e.target as HTMLElement).style.color = '#0F75BC' }}
